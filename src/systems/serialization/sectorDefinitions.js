...
export const sectorDefinitions = {
  'sector-1': {
    ...
    name: 'Aridus Sector',
    planets: [
      { type: 'planet', name: 'Aridus Prime', radius: 80, color: 0x8B4513, greeting: aridusPrimeConversation.greeting, position: { x: 200, y: 0, z: -500 }, rotationSpeed: 0.05, conversation: aridusPrimeConversation },
      { type: 'planet', name: 'Oceanus', radius: 60, color: 0x4169E1, greeting: oceanusConversation.greeting, position: { x: -300, y: 100, z: -800 }, rotationSpeed: 0.07, conversation: oceanusConversation },
